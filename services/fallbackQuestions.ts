...
export const FALLBACK_QUESTIONS: RealQuestion[] = [
  // LINGUAGENS E CODIGOS
  {
    ...
    difficulty: "Médio",
    explanation:
      "O poema utiliza antiteses (deserto/chuva, vida/drama) e paradoxos para expressar contradicoes do amor e da existencia.",
  },
  {
    ...
    discipline: "Linguagens e Códigos",
    statement:
      'No trecho "A gente vai levando a vida como pode", a expressao "a gente" funciona sintaticamente como:',
    options: [
      "A) objeto direto.",
      "B) objeto indireto.",
      "C) sujeito.",
    ...
    difficulty: "Fácil",
    explanation:
      '"A gente" e o sujeito da oracao, equivalendo a "nos" na linguagem coloquial.',
  },
  // MATEMATICA
  {
    id: "fallback_mat_001",
    ...
    statement:
      "Um comerciante comprou um produto por R$ 80,00 e deseja vende-lo com um lucro de 25% sobre o preco de venda. O preco de venda desse produto deve ser:",
    options: [
      "A) R$ 100,00",
      "B) R$ 106,67",
      "C) R$ 96,00",
    ...
    difficulty: "Médio",
    explanation:
      "Se o lucro e 25% sobre o preco de venda (V), entao: V - 80 = 0,25V -> 0,75V = 80 -> V = 80/0,75 = R$ 106,67",
  },
  {
    id: "fallback_mat_002",
    year: 2022,
    ...
    options: ["A) -2", "B) -1", "C) 0", "D) 2", "E) 6"],
    correctAnswer: 0,
    difficulty: "Médio",
    explanation:
      "Yv = -Delta/4a = -(64-48)/8 = -16/8 = -2. Ou: xv = 8/4 = 2, f(2) = 8 - 16 + 6 = -2",
  },
  // CIENCIAS HUMANAS
  {
    id: "fallback_hum_001",
    ...
    statement:
      "A Revolucao Industrial iniciada na Inglaterra no seculo XVIII caracterizou-se principalmente por:",
    options: [
    ...
    difficulty: "Fácil",
    explanation:
      "A 1a Revolucao Industrial se caracterizou pela mecanizacao (maquinas a vapor) e uso intensivo de carvao mineral.",
  },
  {
    id: "fallback_hum_002",
    year: 2022,
    ...
    discipline: "Ciências Humanas",
    statement:
      'O conceito de "mais-valia" desenvolvido por Karl Marx refere-se a:',
    options: [
    ...
    difficulty: "Médio",
    explanation:
      "Mais-valia e o conceito marxista que descreve a apropriacao pelo capitalista do valor excedente produzido pelo trabalhador alem do necessario para sua subsistencia (salario).",
  },
  // CIENCIAS DA NATUREZA
  {
    ...
    difficulty: "Fácil",
    explanation:
      "A 1a Lei da Termodinamica estabelece que a energia total de um sistema isolado permanece constante - nao pode ser criada nem destruida.",
  },
  {
    id: "fallback_nat_002",
    year: 2022,
    ...
    discipline: "Ciências da Natureza",
    statement:
      "O pH de uma solucao aquosa com concentracao de ions H+ igual a 10^-3 mol/L e:",
    options: ["A) 1", "B) 2", "C) 3", "D) 7", "E) 11"],
    correctAnswer: 2,
    difficulty: "Fácil",
