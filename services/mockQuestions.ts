...
export const MOCK_MASSIVE_DB: RealQuestion[] = [
  // DIREITO CONSTITUCIONAL - FGV
  {
    ...
    statement:
      "João, cidadão brasileiro, inconformado com a falta de norma regulamentadora que tornasse inviável o exercício do direito social ao transporte, impetrou mandado de injunção. À luz da sistemática constitucional, o mandado de injunção:",
    options: [
    ...
    difficulty: "Difícil",
    explanation:
      "O Mandado de Injunção é o remédio constitucional cabível sempre que a falta de norma regulamentadora torne inviável o exercício dos direitos e liberdades constitucionais e das prerrogativas inerentes à nacionalidade, à soberania e à cidadania (CF, art. 5º, LXXI).",
    bank: "FGV",
    role: "Auditor Fiscal",
  },
  {
    ...
    statement:
      "A União, no exercício de sua competência privativa, editou lei estabelecendo normas gerais sobre licitações e contratos. O Estado Alfa, por sua vez, editou lei específica sobre o mesmo tema, adequando as normas gerais às suas peculiaridades locais. Diante desse cenário:",
    options: [
    ...
    difficulty: "Médio",
    explanation:
      "Compete privativamente à União legislar sobre normas gerais de licitação e contratação (art. 22, XXVII). Isso não exclui a competência suplementar dos Estados para adequar a matéria às suas especificidades.",
    bank: "FGV",
  ...
  // DIREITO ADMINISTRATIVO - CEBRASPE
  {
    ...
    statement:
      "Acerca dos atributos do ato administrativo, julgue o item a seguir: A imperatividade é o atributo pelo qual os atos administrativos se impõem a terceiros, independentemente de sua concordância.",
    options: ["C) Certo", "E) Errado"],
    correctAnswer: 0,
    difficulty: "Fácil",
    explanation:
      "Correto. A imperatividade (ou coatividade) permite que a administração imponha obrigações aos administrados unilateralmente.",
    bank: "CEBRASPE",
  ...
  },
  {
    ...
    statement:
      "A responsabilidade civil das pessoas jurídicas de direito privado prestadoras de serviço público é objetiva em relação a terceiros usuários e não usuários do serviço, segundo o entendimento atual do STF.",
    options: ["C) Certo", "E) Errado"],
    correctAnswer: 0,
    difficulty: "Difícil",
    explanation:
      "Correto. O STF fixou a tese de que a responsabilidade civil objetiva (Teoria do Risco Administrativo) se aplica às concessionárias de serviço público em relação a terceiros, sejam eles usuários ou não do serviço (RE 591.874).",
    bank: "CEBRASPE",
  ...
  // PORTUGUÊS - FCC
  {
    ...
    difficulty: "Médio",
    explanation:
      'A) "todas" é pronome indefinido (não crase). B) "uma" é artigo indefinido (não crase). C) Correto, fusão de a (preposição) + aquilo. D) "chorar" é verbo (não crase). E) "Vossa Senhoria" é pronome de tratamento (não crase).',
    bank: "FCC",
  ...
  // RLM - FGV
  {
    ...
    statement:
      'Considere a afirmação: "Se chove, então a rua molha". A negação lógica dessa afirmação é:',
    options: [
    ...
    difficulty: "Médio",
    explanation:
      'A negação de uma condicional (Se P então Q) é dada por "P e não Q". Mantém a primeira e nega a segunda. Logo, "Chove E a rua NÃO molha".',
    bank: "FGV",
  ...
  // INFORMATICA - CEBRASPE
  {
    ...
    statement:
      "O phishing é um tipo de ataque de engenharia social em que o atacante tenta enganar a vítima para que ela revele informações confidenciais, como senhas e números de cartão de crédito, fingindo ser uma entidade confiável.",
    options: ["C) Certo", "E) Errado"],
    correctAnswer: 0,
    difficulty: "Fácil",
    explanation:
      "Correto. Phishing (pescaria) é a técnica clássica de enganar o usuário via e-mail ou sites falsos para roubar credenciais.",
    bank: "CEBRASPE",
  ...
  // DIREITO PENAL - FGV
  {
    ...
    statement:
      "Caio, com intenção de matar, dispara arma de fogo contra Tício. Tício é atingido, mas é socorrido a tempo e sobrevive. Nesse caso, Caio responderá por:",
    options: [
    ...
    difficulty: "Fácil",
    explanation:
      "Se o agente inicia a execução de um crime de homicídio (animus necandi), mas o resultado morte não ocorre por circunstâncias alheias à sua vontade, configura-se a tentativa (art. 14, II, CP).",
    bank: "FGV",
  ...
  // LEGISLAÇÃO ADUANEIRA - ESAF (Classic)
  {
    ...
    statement:
      "O regime aduaneiro especial que permite a importação de mercadorias que devam permanecer no País durante prazo fixado, com suspensão total do pagamento de tributos, ou com pagamento proporcional ao tempo de permanência, denomina-se:",
    options: [
    ...
    difficulty: "Médio",
    explanation:
      "Admissão Temporária é o regime que permite a entrada de bens no país por tempo determinado com suspensão total ou parcial (proporcional) de tributos.",
    bank: "ESAF",
