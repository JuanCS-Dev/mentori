        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 flex-1 w-full">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              onChange={(e) =>
                onParamsChange({ ...params, difficulty: e.target.value })
              }
            >
              <option>Facil</option>
              <option>Medio</option>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 w-full">
          <div className="space-y-1">
            ...
            <select
              ...
              value={params.discipline}
              onChange={(e) =>
                onParamsChange({ ...params, discipline: e.target.value })
              }
            >
              {disciplines.map((d) => (
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              value={params.year}
              onChange={(e) =>
                onParamsChange({ ...params, year: parseInt(e.target.value) })
              }
            >
              {years.map((y) => (
...
export const ConcursoControls: React.FC<ConcursoControlsProps> = ({
  ...
  const years =
    availableYears.length > 0 ? availableYears : [2024, 2021, 2020, 2018, 2015];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 flex-1 w-full">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              onChange={(e) =>
                onFilterChange &&
                onFilterChange({ ...filters, bank: e.target.value })
              }
            >
              <option>Todas</option>
