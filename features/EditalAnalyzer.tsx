                ...
                <div className="bg-white border border-kitchen-border rounded-xl overflow-hidden min-h-[800px] flex flex-col shadow-sm">
                    ...
                    <div className="bg-gray-50 border-b border-gray-200 px-8 flex gap-2 pt-2">
                        <button
                            ...
                            className={`px-4 py-2 rounded-t-lg text-sm font-bold font-mono transition-colors ${activeTab === 'overview' ? 'bg-white border-x border-t border-kitchen-border text-blue-600 relative top-[1px]' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100'}`}
                        >
                            Visão Geral
                        </button>
                        <button
                            onClick={() => setActiveTab('vertical')}
                            className={`px-4 py-2 rounded-t-lg text-sm font-bold font-mono transition-colors ${activeTab === 'vertical' ? 'bg-white border-x border-t border-kitchen-border text-blue-600 relative top-[1px]' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100'}`}
                        >
                            Edital Verticalizado
                        </button>
                        <button
