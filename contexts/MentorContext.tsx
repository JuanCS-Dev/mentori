...
export const MentorProvider: React.FC<MentorProviderProps> = ({
  children,
  currentView,
}) => {
  ...
  // Format history for Nebius (OpenAI compatible)
  const formatHistory = (
    msgs: MentorMessage[],
  ...
  const sendMessage = useCallback(
    async (input: string) => {
      ...
      try {
        ...
        for await (const chunk of NebiusService.mentorChat(
          input,
          history,
          context,
        )) {
