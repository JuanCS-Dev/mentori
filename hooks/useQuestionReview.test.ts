...
describe("useQuestionReview", () => {
  ...
  describe("prioritizeQuestions", () => {
    it("should put due questions first", () => {
      ...
      const prioritized = result.current.prioritizeQuestions([
        mockQuestion,
        mockQuestion2,
      ]);
  ...
  describe("stats", () => {
    ...
    it("should track by discipline", () => {
      ...
      expect(
        result.current.stats.byDiscipline["Direito Constitucional"],
      ).toBeDefined();
      expect(
        result.current.stats.byDiscipline["Direito Administrativo"],
      ).toBeDefined();
    });
  });
